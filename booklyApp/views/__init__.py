from .viewsAuthor import AuthorViewSet
from .viewsBook import BookViewSet
from .viewsComment import CommentViewSet
from .viewsFavorite import FavoriteViewSet
